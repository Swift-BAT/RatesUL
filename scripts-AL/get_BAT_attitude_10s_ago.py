...
if os.path.exists(att_filename):
	...
	for i in range(len(att_fits_data)):
		...
		if (dt < 2.5):
			flag_att = 1
			print 'BAT_RA_10s_ago:', pointing_RA
			print 'BAT_DEC_10s_ago:', pointing_DEC
			print 'BAT_ROLL_10s_ago:', pointing_ROLL
			break
	...
	if os.path.exists(att_filename):
		...
		#print time, pointing_RA, pointing_DEC, pointing_ROLL
			...
			if (dt < 2.5):
				...
				print 'BAT_DEC_10s_ago:', pointing_DEC
				print 'BAT_ROLL_10s_ago:', pointing_ROLL
				print 'BAT_RA_from_HANS_10s_ago:', pointing_RA
				print 'BAT_DEC_from_HANS_10s_ago:', pointing_DEC
				print 'BAT_ROLL_from_HANS_10s_ago:', pointing_ROLL
				print 'BAT_pointing_from_HANS_10s_ago:time_min:', dt
				break
