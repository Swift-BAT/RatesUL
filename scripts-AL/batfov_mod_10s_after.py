...
BAT_RA = float(sys.argv[1])
BAT_DEC = float(sys.argv[2])
BAT_ROLL = float(sys.argv[3])
output_dir = sys.argv[4]

# radecroll = (0.0, 0.0, 0.0)

#radecroll = (36.334, 3.626, 79.021)
#radecroll = (67.5679911006252, -9.57753113773722, 87.3696441650391)
#radecroll = (61.6307658635680, -9.84379933611689, 89.8621063232422)
#radecroll = (169.808442574054, -61.5089029562529, 338.215576171875)
#radecroll = (303.801, 18.642, 294.29)
...
for i in range(nra):
	...
	effarea_num = openarea * costheta
	if (effarea_num > 0.0):
		effarea[j,i] = openarea * costheta
	else:
                effarea[j,i] = 'NaN'

#      	effarea_100percent = 4363.9596
#        pcode = effarea_num/effarea_100percent
#        if (pcode > 0.0):
#                effarea[j,i] = openarea * costheta
#        else:
#                effarea[j,i] = 'NaN'
...
hdu.data = effarea
hdu.writeto(output_dir + '/batfov_10s_after.fits', clobber=True)
