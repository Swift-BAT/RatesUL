...
set T0_10s_ago = `cat ${info_file} | grep "T0_10s_ago:" | awk '{print $2}'`
...
python get_BAT_attitude_10s_ago.py ${T0_10s_ago} ${T0_year} ${T0_doy} ${output_dir}/pass_data ${att_folder} >> ${info_file}
python get_Earth_pos_10s_ago.py ${info_file} >> ${info_file}
